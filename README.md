...
| 项目 | 文件夹 | 封面 | 截图 |
|------|--------|------|------|
| 漫威争锋 | `01/` | 视频自动播放 | `shot1`、`shot2`... |
| 星痕共鸣 | `02/` | 视频自动播放 | `shot1`、`shot2`... |
| 仙王第五季 | `03/` | `cover` | `shot1`、`shot2`... |
| 狐妖小红娘 | `04/` | `cover` | `shot1`、`shot2`... |
| 原创IP | `05/` | `cover` | `shot1`、`shot2`... |

- 有视频链接的项目：封面自动播放视频，不需要 `cover.jpg`
- 无视频链接的项目：需要上传 `cover` 作为封面
